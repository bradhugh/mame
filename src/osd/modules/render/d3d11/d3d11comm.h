...
//============================================================
//
//  d3d11comm.h - Common Win32 Direct3D 11 structures
//
//============================================================

#ifndef __WIN_D3D11COMM__
#define __WIN_D3D11COMM__
...
namespace d3d11
{
	...
	//============================================================
	#ifdef _DEBUG
	#define NAME_OBJECT(o, name) if (true) { o->SetPrivateData(WKPDID_D3DDebugObjectName, sizeof(name) - 1, name); }
	#else
	#define NAME_OBJECT(o, name)
	#endif
	...
	public:
		...
		DXGI_FORMAT               get_yuv_format() { return m_yuv_format; }
	...
	public:
		...
		Microsoft::WRL::ComPtr<ID3D11Texture2D>				get_tex() { return m_d3dtex; }
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>	get_surface() { return m_d3dsurface; }
		void set_surface(Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> value) { m_d3dsurface = value; }
		Microsoft::WRL::ComPtr<ID3D11Texture2D>				get_finaltex() { return m_d3dfinaltex; }
	...
	private:
		...
		Microsoft::WRL::ComPtr<ID3D11Texture2D>				m_d3dtex;		// Direct3D texture pointer
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>	m_d3dsurface;   // Direct3D offscreen plain surface pointer
		Microsoft::WRL::ComPtr<ID3D11Texture2D>				m_d3dfinaltex;	// Direct3D final (post-scaled) texture
	};
	...
	public:
		...
		void init(D3D11_PRIMITIVE_TOPOLOGY type, UINT32 count, UINT32 numverts,
			UINT32 flags, d3d11::texture_info *texture, UINT32 modmode,
		...
		D3D11_PRIMITIVE_TOPOLOGY    get_type() { return m_type; }
		UINT32						get_count() { return m_count; }
		UINT32						get_vertcount() { return m_numverts; }
		UINT32						get_flags() { return m_flags; }

		d3d11::texture_info *		get_texture() { return m_texture; }
	...
	private:
		...
		D3D11_PRIMITIVE_TOPOLOGY    m_type;                       // type of primitive
	...
	// TODO: update vector size and input layout
	struct vertex
	{
		float				x, y, z;                    // X,Y,Z coordinates
		float				rhw;                        // RHW when no HLSL, padding when HLSL
		D3DXVECTOR4			color;                      // diffuse color
